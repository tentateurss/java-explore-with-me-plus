...
public class CompilationMapper {
    ...
    public CompilationDto toDto(Compilation compilation, Map<Long, EventStatistics> stats) {
        ...
        dto.setEvents(compilation.getEvents()
                ...
                .map(event -> EventMapper.toShortDto(event,
                        stats.getOrDefault(event.getId(), new EventStatistics(0, 0))))
    ...
    public void updateEntity(UpdateCompilationRequest dto, @Nullable Set<Event> events, Compilation compilation) {
